...
module.exports = async (screenshotFilename, userID) => {
  /* `basename` strips any path smuggled into the filename (COS-295). Both arguments come from
   * the query string of `GET /bookmarks/upload/:id`, and concatenating them straight into a
   * path let a relative segment escape this directory — the same class of bug as the SQL this
